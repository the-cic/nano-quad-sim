...
public class MaterialLibrary {
    ...
    public Material gateFront;
    public Material gateBack;

    public Texture ortofotoTexture;
    ...
    public MaterialLibrary(AssetManager assetManager) {
        ...
        ColorRGBA transparentRed = ColorRGBA.Red.clone();
        ColorRGBA transparentGreen = ColorRGBA.Green.clone();
        transparentRed.a = 0.15f;
        transparentGreen.a = 0.25f;

        gateFront = new Material(assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        gateFront.setColor("Color", transparentGreen);
        gateFront.setColor("GlowColor", transparentGreen);
        gateFront.getAdditionalRenderState().setBlendMode(RenderState.BlendMode.Alpha);

        gateBack = new Material(assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        gateBack.setColor("Color", transparentRed);
        gateBack.setColor("GlowColor", transparentRed);
        gateBack.getAdditionalRenderState().setBlendMode(RenderState.BlendMode.Alpha);

        grassTexture = assetManager.loadTexture("Textures/Terrain/splat/grass.jpg");
        ortofotoTexture = assetManager.loadTexture("Textures/Terrain/Trzaska/trzaska-sat.png");
        grassNormalTexture = assetManager.loadTexture("Textures/Terrain/splat/grass_normal.jpg");
        dirtTexture = assetManager.loadTexture("Textures/Terrain/Trzaska/Ground14_1.jpg");
        concreteTexture = assetManager.loadTexture("Textures/General/concrete.jpg");
        silhouetteTexture = assetManager.loadTexture("Textures/General/silhouette.jpg");
        treeTexture = assetManager.loadTexture("Textures/General/tree.jpg");
        treeAlphaTexture = assetManager.loadTexture("Textures/General/tree-alpha.jpg");
        ...
        grassTerrain.setTexture("AlphaMap", assetManager.loadTexture("Textures/Terrain/Trzaska/trzaska-alpha2.png"));
        //grassTerrain.setTexture("AlphaMap_1", assetManager.loadTexture("Textures/Trzaska/trzaska-alpha.png"));
        //grassTerrain.setTexture("Tex1", grassTexture);
        //grassTerrain.setFloat("Tex1Scale", 4f);
        grassTerrain.setTexture("DiffuseMap", ortofotoTexture);
        grassTerrain.setFloat("DiffuseMap_0_scale", 1f);
        grassTerrain.setTexture("DiffuseMap_1", grassTexture);
        grassTerrain.setFloat("DiffuseMap_1_scale", 256f);
        grassTerrain.setTexture("DiffuseMap_2", dirtTexture);
        grassTerrain.setFloat("DiffuseMap_2_scale", 256f);
        //grassTerrain.setTexture("DiffuseMap_5", dirtTexture);
        //grassTerrain.setFloat("DiffuseMap_5_scale", 16f);
